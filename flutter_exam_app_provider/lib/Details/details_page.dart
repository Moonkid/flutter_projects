...
import 'package:flutter_exam_app_provider/details/location_provider.dart';
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: ChangeNotifierProvider<LocationProvider>(
                builder: (context) => LocationProvider()..updateLocation(),
  ...
  Widget _buildDistance(BuildContext context) {
    return Consumer<LocationProvider>(
      builder: (context, provider, _) {
        if (provider.status == LocationStatus.loaded) {
          final km = const Distance().as(LengthUnit.Kilometer,
              provider.currentPosition, LatLng(user.latitude, user.longitude));
          return Text(
